...
class _AdminDashboardScreenState extends ConsumerState<AdminDashboardScreen> {
  ...
  void _viewPaymentProof(String? base64Image) {
    if (base64Image == null || base64Image.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text("No proof attached")));
      return;
    }
                                      ...
                                      children: [
                                        ...
                                        if (profile != null) ...[
                                          ...
                                          if (subscription?['expiryDate'] !=
                                              null)
                                            Text(
                                              "Expires: ${subscription['expiryDate'].toString().split('T')[0]}",
                                            ),
                                        ] else
                                          const Text(
                                            "No Profile Setup",
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            if (subscription != null &&
                                                subscription['paymentProofImage'] !=
                                                    null)
                                              TextButton.icon(
